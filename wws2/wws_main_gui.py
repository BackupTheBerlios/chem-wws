#!/usr/bin/env python
# -*- coding: UTF-8 -*-
# generated by wxGlade 0.4.1cvs on Sat Aug 26 21:20:08 2006
...
class wwsMainFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.wws_main_frame_toolbar.AddLabelTool(50, u"Schließen", wx.Bitmap("/home/tweimann/workspace/wws2/icon/exit.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, "Programm beenden", u"Schließt die Anwendung")
        self.wws_main_frame_toolbar.AddSeparator()
        self.wws_main_frame_toolbar.AddLabelTool(51, "Mail", wx.Bitmap("/home/tweimann/workspace/wws2/icon/mail.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, u"Mailprogramm öffnen", u"Öffnet das integrierte Mailprogramm")
        self.wws_main_frame_toolbar.AddSeparator()
        self.wws_main_frame_toolbar.AddLabelTool(53, "Einstellungen", wx.Bitmap("/home/tweimann/workspace/wws2/icon/config.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, "Anwendung einrichten", "Einstellungen anpassen")
        self.wws_main_frame_toolbar.AddSeparator()
        self.wws_main_frame_toolbar.AddLabelTool(52, "Hilfe", wx.Bitmap("/home/tweimann/workspace/wws2/icon/help.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, "Onlinehilfe", u"Öffnet die Onlinehilfe")
        # Tool Bar end
        ...
        try:
            ...
            self.setStatus(text)
            self.SetTitle('Warenwirtschaftssystem V %s' % Config.Version)
        except:
            pass
    ...
    def wwsAbout(self, event): # wxGlade: wwsMainFrame.<event_handler>
        title = u'Warenwirtschaftssystem - V ' + str(Config.Version)
        text  = u''
        text += u''
        text += u''
        text += u''
...
class wwsLoginDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.bitmap_button_1 = wx.BitmapButton(self, -1, wx.Bitmap("/home/tweimann/workspace/wws2/icon/commit.png", wx.BITMAP_TYPE_ANY))
